package com.example.elam.todo1sa.activitys;
...
import com.example.elam.todo1sa.DateComparator;
import com.example.elam.todo1sa.R;
import com.example.elam.todo1sa.adapters.AdaPter;
import com.example.elam.todo1sa.beans.beans;
import com.example.elam.todo1sa.database.DbHealper;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        menu.add(0, MarkAsCompleated, 1, "I've Completed this Task");
...
//mark the task as compleated
        if (item.getItemId() == MarkAsCompleated && item.getGroupId() == 0) {
            ...
            int updateTaskStatus = db.updateTaskStatus(theTask.getId(), 1);
        ...
        if (item.getItemId() == DelteTask && item.getGroupId() == 0) {
            ...
            boolean isdeleted = db.deleteTask(delete.getId());
